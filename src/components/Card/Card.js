        ...
        return (
            <div className="card br3 bg-white shadow-5 ph2 dib mr4 grow">
                <div className="card-prod-desc pa3 pb2 pl0 ">
                    <div className="fl w-5 dib">
                        <FontAwesomeIcon icon={faFileAlt} className="f4" />
                    </div>
                    <div className="dib">
                    ...
                    <div className="card-price fr dib">
                        ...
                        <div className="dib">
                            <p className="f5 b ma0 dib pa0 ml3 v-top">₹ 1250</p>
                            <p className="f7 b light-gray pt0 ml3 v-top"><a>Update</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div className="ma0 f7 mt1 ml3 fw8 mid-gray">
                    ...
                    {/* <div className="w-30 dib tc mr2 dim">
